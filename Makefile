...
DB_URL=postgresql://postgres:postgres@localhost:5432/devboard?sslmode=disable
...
## test: correr todas los tests con race detector
...
## migrate-down: revertir la última migración aplicada
migrate-down:
